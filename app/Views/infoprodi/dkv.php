...
<div> <img src="<?= base_url('asset/gambar/dkv1.png.jpg')?>" class="rounded float-left" style= margin-top:-5.5%   > </div>
<br><br>
<h1 class="text-black text-center">Design Komunikasi Visual</h1> 
</div>
</div>
