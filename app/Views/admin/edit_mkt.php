			...
			<div class="container">
                    <div class="row">
                        <div class="col-sm-9">
                            ...
                            <form action="<?= base_url('admin/mastermkt/update'); ?>" method="POST">
                                <input type="hidden" name="id_mhs" value="<?= $marketing['id_marketing'] ?>">
                                <div class="form-grup">
                                    <label for="name">Nama Pengguna</label>
                                    <br>
                                    <input type="text" name="nama_pengguna" class="form-control" id="name" placeholder="Masukkan Nama"
                                    value="<?= $marketing['nama_pengguna'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                    <label for="email">Username</label>
                                    <br>
                                    <input type="text" name="ttl" class="form-control" id="email" placeholder="Masukkan Username"
                                    value="<?= $marketing['username'] ?>">
                                    <br>
                                </div>
