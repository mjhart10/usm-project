                                ...
                                <?php if ($mahasiswa) : ?>
                                    <?php foreach ($mahasiswa as $mhs) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/mastermhs/edit/' . $mhs['id_mhs']); ?>" class="btn btn-success">Edit</a>
                                                <a href="<?= base_url('admin/mastermhs/delete/' . $mhs['id_mhs']); ?>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
