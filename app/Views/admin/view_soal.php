	...
	<div class="content transition">
		<div class="container-fluid dashboard">
			...
			<div class="container mt-5">
                    <h2> List Users </h2>   
                    <a href="<?= base_url('admin/mastersoal/create')?>" class="btn btn-success mb-2">Add User</a>
                    <div class="row mt-3">
                        <div class="col-sm-12">
                                ...
                                <?php if ($bank_soal) : ?>
                                    <?php foreach ($bank_soal as $soal) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/mastersoal/edit/' . $soal['no_soal']); ?>" class="btn btn-success">Edit</a>
                                                <a href="<?= base_url('admin/mastersoal/delete/' . $soal['no_soal']); ?>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
