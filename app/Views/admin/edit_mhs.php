		...
		<div class="container-fluid dashboard">
			...
			<div class="container">
                    <div class="row">
                        <div class="col-sm-9">
                            <h2>Edit Mahasiwa</h2>
                            <form action="<?= base_url('admin/mastermhs/update'); ?>" method="POST">
                                ...
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="ttl" class="form-control" id="email" placeholder="Masukkan Email"
                                    value="<?= $mahasiswa['ttl'] ?>">
                                    <br>
                                </div>
                                 <div class="form-grup">
                                    <label for="contact">Nomor NIK (KTP)</label>
                                    <br>
                                    <input type="text" name="nik" class="form-control" id="contact_no" placeholder="Masukkan Nomor Contact"
                                    value="<?= $mahasiswa['nik'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="alamt" class="form-control" id="contact_no" placeholder="Masukkan Nomor Contact"
                                    value="<?= $mahasiswa['alamat'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                    <label for="contact">Kode Pos</label>
                                    <br>
                                    <input type="text" name="kode_pos" class="form-control" id="contact_no" placeholder="Masukkan Nomor Contact"
                                ...
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="no_handphone" class="form-control" id="contact_no" placeholder="Masukkan Nomor Contact"
                                ...
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="email" class="form-control" id="contact_no" placeholder="Masukkan Nomor Contact"
                                    value="<?= $mahasiswa['email'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                    <label for="contact">Asal Sekolah</label>
                                    <br>
                                    <input type="text" name="asal_sekolah" class="form-control" id="contact_no" placeholder="Masukkan Nomor Contact"
