			...
			<div class="container">
                    <div class="row">
                        <div class="col-sm-9">
                            ...
                            <form action="<?= base_url('admin/masteradmin/update'); ?>" method="POST">
                                <input type="hidden" name="id_admin" value="<?= $admin['id_admin'] ?>">
                                <div class="form-grup">
                                    <label for="name">Nama Pengguna</label>
                                    <br>
                                    <input type="text" name="nama_admin" class="form-control" id="name" placeholder="Masukkan Nama"
                                ...
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="username" class="form-control" id="email" placeholder="Masukkan Username"
                                ...
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="email" class="form-control" id="email" placeholder="Masukkan Username"
                                    value="<?= $admin['email'] ?>">
                                    <br>
                                </div>
                                ...
                                <div class="form-grup">
                                    ...
                                    <a href="<?= base_url('admin/masteradmin/view')?>" class="btn btn-danger">Close</a>
                                </div>
