        ...
        <div class="container-fluid dashboard">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-9">
                        <h2>Tambah Soal</h2>
                        <form action="<?= base_url('admin/mastersoal/store'); ?>" method="POST">
                            <input type="hidden" name="id_mhs" value="">
                            <div class="form-grup">
                                <label for="name">Isi Soal</label>
                                <br>
                                <input type="text" name="isi_soal" class="form-control" id="name"
                                    placeholder="Masukkan soal" value="">
                                <br>
                            </div>
                            <div class="form-grup">
                                <label for="email">Opsi A</label>
                                <br>
                                <input type="text" name="option_a" class="form-control" id="email"
                                    placeholder="Masukkan Username" value="">
                                <br>
                            </div>
                            <div class="form-grup">
                                <label for="email">Opsi B</label>
                                <br>
                                <input type="text" name="option_b" class="form-control" id="password"
                                    placeholder="Masukkan opsi">
                                <br>
                            </div>
                            <div class="form-grup">
                                <label for="email">Opsi C</label>
                                <br>
                                <input type="text" name="option_c" class="form-control" id="password"
                                    placeholder="Masukkan opsi">
                                <br>
                            </div>
                            <div class="form-grup">
                                <label for="email">Osi D</label>
                                <br>
                                <input type="text" name="option_d" class="form-control" id="password"
                                    placeholder="Masukkan opsi">
                                <br>
                            </div>
                            <div class="form-grup">
                                <label for="email">Jawaban</label>
                                <br>
                                <input type="text" name="jawaban" class="form-control" id="password"
                                    placeholder="Masukkan jawaban A/B/C/D">
                                <br>
                            </div>

                            <div class="form-grup">
                                <button type="submit" id="send_form" class="btn btn-success">Submit</button>
                                <a href="<?= base_url('admin/mastersoal/index')?>"
