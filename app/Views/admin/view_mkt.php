                            ...
                            <tbody>
                                <?php if ($marketing) : ?>
                                    <?php foreach ($marketing as $mkt) : ?>
                                        <tr>
                                            <td><?= $mkt['id_marketing']; ?></td>
                                            <td><?= $mkt['nama_pengguna']; ?></td>
                                            <td><?= $mkt['username']; ?></td>         
                                            <td>
                                                <a href="<?= base_url('admin/mastermkt/edit/' . $mkt['id_marketing']); ?>" class="btn btn-success">Edit</a>
                                                <a href="<?= base_url('admin/mastermkt/delete/' . $mkt['id_marketing']); ?>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
